 ...
 * STYLE DEFINITIONS
 *
 * Each style has a matching high-resolution interior design example image
 * and prompt template for AI generation.
 */
...
export const STYLES: StyleDefinition[] = [
  {
    ...
    gradient:
      "linear-gradient(135deg, hsl(220 15% 18%) 0%, hsl(210 30% 20%) 100%)",
  ...
  },
  {
    ...
    gradient:
      "linear-gradient(135deg, hsl(0 0% 96%) 0%, hsl(0 0% 82%) 100%)",
  ...
  },
  {
    ...
    gradient:
      "linear-gradient(135deg, hsl(35 30% 90%) 0%, hsl(25 15% 78%) 100%)",
  ...
  },
  {
    ...
    gradient:
      "linear-gradient(135deg, hsl(20 8% 20%) 0%, hsl(25 15% 22%) 100%)",
  ...
  },
  {
    ...
    gradient:
      "linear-gradient(135deg, hsl(80 15% 75%) 0%, hsl(30 15% 85%) 100%)",
  ...
  },
  {
    ...
    gradient:
      "linear-gradient(135deg, hsl(270 30% 15%) 0%, hsl(40 60% 30%) 100%)",
  ...
  },
  {
    ...
    gradient:
      "linear-gradient(135deg, hsl(15 50% 45%) 0%, hsl(35 40% 50%) 100%)",
    image: "/images/landing/style-bohemian.png",
  ...
  },
  {
    ...
    gradient:
      "linear-gradient(135deg, hsl(25 30% 30%) 0%, hsl(30 25% 35%) 100%)",
    image: "/images/landing/style-rustic.png",
  ...
  },
  {
    ...
    gradient:
      "linear-gradient(135deg, hsl(200 40% 20%) 0%, hsl(160 30% 30%) 100%)",
    image: "/images/landing/style-contemporary.png",
  ...
  },
  {
    ...
    gradient:
      "linear-gradient(135deg, hsl(220 30% 15%) 0%, hsl(220 20% 18%) 100%)",
    image: "/images/landing/style-traditional.png",
